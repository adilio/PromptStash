...
export type WorkflowPattern = Database['public']['Tables']['workflow_patterns']['Row'];
export type WorkflowPatternStep = Database['public']['Tables']['workflow_pattern_steps']['Row'];
export type WorkflowPatternWithSteps = WorkflowPattern & { steps: WorkflowPatternStep[] };
